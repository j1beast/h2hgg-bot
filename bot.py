...
async def test_betsson(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        for phase in ["Upcoming"]:
            url = f"https://www.betsson.es/api/sb/v1/widgets/events-table/v2?categoryIds=4&competitionIds=25847&eventPhase=Upcoming&eventSortBy=StartDate&includeSkeleton=true&maxMarketCount=1&pageNumber=1&regionIds=243&priceFormats=1&marketTemplateIds=MW2W"
